            ...
            render: (record) => {
                ...
                return (
                    <Grid className={classes.buttons}>
                        <Button disabled={isLoading} title={'Accept'}  
                        onClick={()=>{}}
                        />
                        
                        <Button backgroundColor='red'  disabled={isLoading} title={'Reject'} 
                        onClick={()=>{}} 
                        />
                    </Grid>
                )
...
//         <DashboardLayout>
//            <AppBar
//         breadcrumbs={[{ route: "/radar", name: 'Consultant Management' }]}
//       />
//             <Grid container className="mt-4" >
...
//             {/* <Navbar title={'Consultant Management'} searchable value={search} onChange={(e)=>handleSearching(e)} /> */}
//             <Card className={classes.card}>
//                 {matches &&
//                 <Box className={classes.searchBox}>
